...
public class GameGraphics{
    ImageLoader killsLastRound, mostKills, labelGame1, shipShieldGame, background, helpTab, pressShift, pause;
    GameLogic logic;
    Player player;
    ...
    public void draw(Graphics g){
        ...
        if (logic.isGameActive()){
            ...
            if(logic.getPlayer().getCash() >= 30 && !logic.shipShieldActive){
